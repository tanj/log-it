...
"""
    ...
    This is the default configuration for log_it that every site should have.
...
class DefaultConfig(object):
    ...
    # Example for the log_it forums: SERVER_NAME = "forums.flaskbb.org"
    # SERVER_NAME =
    ...
    # If None this defaults to log_it/logs
    #
    ...
    LOG_DEFAULT_CONF = {
        ...
        "handlers": {
            ...
            "log_it": {
                ...
                "filename": os.path.join(LOG_PATH, "log_it.log"),
                "mode": "a",
    ...
    # log_it logging configuration which uses the settings
    ...
    # ------------------------------
    # For MySQL:
    # SQLALCHEMY_DATABASE_URI="mysql+pymysql://log_it:password@localhost:3306/log_it"
    # For PostgresSQL:
    # SQLALCHEMY_DATABASE_URI = "postgresql://log_it@localhost:5432/log_it"
    # For SQLite:
    SQLALCHEMY_DATABASE_URI = "sqlite:///" + basedir + "/" + "log_it.sqlite"
    ...
    # ALEMBIC = {
    #     'script_location': os.path.join(basedir, "log_it/migrations"),
    #     'version_locations': '',
